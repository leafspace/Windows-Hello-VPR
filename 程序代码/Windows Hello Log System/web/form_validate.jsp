                                ...
                                <form action="" class="am-form" data-am-validator>
                                    <fieldset>
                                        ...
                                        <div class="am-form-group">
                                            ...
                                            <div class="am-form-group" style="width: 48%; float: right;">
                                                ...
                                                <select id="ClientType">
                                                    ...
                                                    <option value="Windows Hello Client">Windows Hello Client</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="am-form-group">
                                            <div class="am-form-group" style="width: 48%; float: left;">
                                                <label>发布时间：</label>
                                                <input type="text" minlength="3" placeholder="输入时间（格式：年-月-日 时:分:秒）" required/>
                                            </div>
                                            <div class="am-form-group" style="width: 48%; float: right;">
                                                <label>客户端IP：</label>
                                                <input type="text" minlength="3" placeholder="输入IP（格式：IP:PORT）" required/>
                                            </div>
                                        </div>
